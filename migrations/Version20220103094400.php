 ...
 */
final class Version20220103094400 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE st_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('DROP TABLE type');
        $this->addSql('ALTER TABLE st_media CHANGE type type_id INT NOT NULL');
        $this->addSql('ALTER TABLE st_media ADD CONSTRAINT FK_E0C5111C54C8C93 FOREIGN KEY (type_id) REFERENCES st_type (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
